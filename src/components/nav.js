    ...
    <nav className="lg:flex lg:content-end lg:justify-end lg:flex-col">
      <div className={`navigation-wrapper navigation-wrapper--${menuActive}`} >
        <ul className="md:bg-red md:flex md:w-full md:flex-row md:justify-start md:items-stretch">
          ...
          <li>
            <a target="_blank" rel="noreferrer noopener" onClick={this.toggleMenu} className="navigation-wrapper__link" href="https://github.com/indiealistic/indiemotion-gatsby/">Github <GoLinkExternal className="inline-block opacity-25 -mt-3px" /></a>
          </li>
        </ul>
      </div>
